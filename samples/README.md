...
| [Azure App Service Deployment](Deployment/AzureAppService) | An Orleans 10 shopping cart with managed identity, private silo networking, health checks, Bicep, and OIDC deployment to Azure App Service. | [dotnet/orleans](https://github.com/dotnet/orleans) |
...
| [Azure App Service Deployment](Deployment/AzureAppService) | An Orleans 10 shopping cart with managed identity, private silo networking, health checks, Bicep, and OIDC deployment to Azure App Service. | C#, Razor, Bicep, YAML | deployment, azure, app-service | [dotnet/orleans](https://github.com/dotnet/orleans) |
