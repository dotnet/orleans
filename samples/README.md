...
| [Azure App Service Deployment](Deployment/AzureAppService) | A shopping cart and infrastructure template for deploying an Orleans cluster to Azure App Service. | [Azure-Samples/Orleans-Cluster-on-Azure-App-Service](https://github.com/Azure-Samples/Orleans-Cluster-on-Azure-App-Service) |
| [Azure Container Apps Deployment](Deployment/AzureContainerApps) | An end-to-end Orleans cluster, client, dashboard, scaler, and Bicep deployment for Azure Container Apps. | [Azure-Samples/Orleans-Cluster-on-Azure-Container-Apps](https://github.com/Azure-Samples/Orleans-Cluster-on-Azure-Container-Apps) |
...
| [Azure App Service Deployment](Deployment/AzureAppService) | A shopping cart and infrastructure template for deploying an Orleans cluster to Azure App Service. | C#, Razor, Bicep, YAML | deployment, azure, app-service | [Azure-Samples/Orleans-Cluster-on-Azure-App-Service](https://github.com/Azure-Samples/Orleans-Cluster-on-Azure-App-Service) |
| [Azure Container Apps Deployment](Deployment/AzureContainerApps) | An end-to-end Orleans cluster, client, dashboard, scaler, and Bicep deployment for Azure Container Apps. | C#, Bicep, YAML | deployment, azure, container-apps, autoscaling | [Azure-Samples/Orleans-Cluster-on-Azure-Container-Apps](https://github.com/Azure-Samples/Orleans-Cluster-on-Azure-Container-Apps) |
