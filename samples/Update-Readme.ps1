...
$lines.Add('```')
$lines.Add('')
$lines.Add('The command checks the gallery manifest and builds every project in `Samples.slnx`. Azure services are required only when running samples which use them, not when compiling.')
$lines.Add('')
