...
public static class CassandraMembershipHostingExtensions
{
    ...
    public static IClientBuilder UseCassandraClustering(this IClientBuilder builder, ClusterOptions clusterOptions, Func<IServiceProvider, ISession> sessionProvider) =>
        builder.ConfigureServices(services =>
        {
    ...
    /// <returns></returns>
    public static IClientBuilder UseCassandraClustering(this IClientBuilder builder, ClusterOptions clusterOptions, CassandraClusteringOptions cassandraOptions) =>
        builder.ConfigureServices(services =>
        {
