...
/// <summary>
/// Extensions to <see cref="ISiloBuilder"/> for configuring the in-memory advanced reminder provider.
/// </summary>
public static class SiloBuilderReminderMemoryExtensions
{
    /// <summary>
    /// Configures advanced reminder storage using an in-memory, non-persistent store.
    /// </summary>
