...
public static class GrainReminderExtensions
{
    ...
    public static Task<IGrainReminder> RegisterOrUpdateAdvancedReminder(this Grain grain, string reminderName, ReminderSchedule schedule)
        => RegisterOrUpdateAdvancedReminder(IsRemindable(grain), grain?.GrainContext, reminderName, schedule, Runtime.MissedReminderAction.Skip);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateAdvancedReminder(
        ...
        => RegisterOrUpdateAdvancedReminder(IsRemindable(grain), grain?.GrainContext, reminderName, dueTime, period, action);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateAdvancedReminder(
        ...
        TimeSpan period,
        Runtime.MissedReminderAction action)
        => RegisterOrUpdateAdvancedReminder(IsRemindable(grain), grain?.GrainContext, reminderName, dueAtUtc, period, action);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateAdvancedReminder(
        ...
        Runtime.MissedReminderAction action)
        => RegisterOrUpdateAdvancedReminder(IsRemindable(grain), grain?.GrainContext, reminderName, schedule, action);
        ...
        Runtime.MissedReminderAction action)
    {
        ...
        return GetReminderRegistry(grainContext).RegisterOrUpdateReminder(grainContext.GrainId, reminderName, schedule, action);
    }
