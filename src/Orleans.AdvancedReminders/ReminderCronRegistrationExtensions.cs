...
public static class ReminderCronRegistrationExtensions
{
    public static Task<IGrainReminder> RegisterOrUpdateReminder(
        ...
        => RegisterCronReminder(registry, callingGrainId, reminderName, cronExpression, cronTimeZoneId: null, DurableJobPriority.Normal, Runtime.MissedReminderAction.Skip);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateReminder(
        ...
        string reminderName,
        string cronExpression)
        => RegisterCronReminder(service, grainId, reminderName, cronExpression, cronTimeZoneId: null, DurableJobPriority.Normal, Runtime.MissedReminderAction.Skip);
