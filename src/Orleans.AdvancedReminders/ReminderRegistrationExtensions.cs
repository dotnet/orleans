...
public static class ReminderRegistrationExtensions
{
    public static Task<IGrainReminder> RegisterOrUpdateReminder(
        ...
        TimeSpan dueTime,
        TimeSpan period)
        => registry.RegisterOrUpdateReminder(callingGrainId, reminderName, ReminderSchedule.Interval(dueTime, period), DurableJobPriority.Normal, Runtime.MissedReminderAction.Skip);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateReminder(
        ...
        DateTime dueAtUtc,
        TimeSpan period)
        => registry.RegisterOrUpdateReminder(callingGrainId, reminderName, ReminderSchedule.Interval(dueAtUtc, period), DurableJobPriority.Normal, Runtime.MissedReminderAction.Skip);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateReminder(
        ...
        TimeSpan dueTime,
        TimeSpan period)
        => service.RegisterOrUpdateReminder(grainId, reminderName, ReminderSchedule.Interval(dueTime, period), DurableJobPriority.Normal, Runtime.MissedReminderAction.Skip);
    ...
    public static Task<IGrainReminder> RegisterOrUpdateReminder(
        ...
        DateTime dueAtUtc,
        TimeSpan period)
        => service.RegisterOrUpdateReminder(grainId, reminderName, ReminderSchedule.Interval(dueAtUtc, period), DurableJobPriority.Normal, Runtime.MissedReminderAction.Skip);
