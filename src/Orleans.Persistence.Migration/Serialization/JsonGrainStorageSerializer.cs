...
namespace Orleans.Storage
{
    ...
    {
        private readonly OrleansMigrationJsonSerializer _orleansJsonSerializer;

        /// <summary>
        /// Initializes a new instance of the <see cref="JsonGrainStorageSerializer"/> class.
        /// </summary>
        public JsonGrainStorageSerializer(OrleansMigrationJsonSerializer orleansJsonSerializer)
        {
