...
namespace Tester.CodeGenTests
{
    ...
    public class RuntimeGenericGrain : Grain<IGenericGrainState<@event>>, IRuntimeCodeGenGrain<@event>
    {
        public Task<IGenericGrainState<@event>> SetState(IGenericGrainState<@event> value)
        {
    ...
    public interface IRuntimeCodeGenGrain<T> : IGrainWithGuidKey
    {
        ...
        Task<IGenericGrainState<T>> SetState(IGenericGrainState<T> value);
    ...
    public interface IGenericGrainState<T> : IGrainState
    {
        /// <summary>
    ...
    public class GenericGrainState<T> : GrainState, IGenericGrainState<T>
    {
