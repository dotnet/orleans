...
namespace Orleans.Streams
{
    ...
    internal sealed class StreamImpl<T> : IAsyncStream<T>, IStreamControl, IOnDeserialized
    {
        ...
        private IInternalStreamProvider? GetStreamProvider() => runtimeClient?.ServiceProvider.GetRequiredServiceByName<IStreamProvider>(streamId.ProviderName) as IInternalStreamProvider;
        ...
        void IOnDeserialized.OnDeserialized(DeserializationContext context) => runtimeClient = context?.RuntimeClient as IRuntimeClient;
    }
}
