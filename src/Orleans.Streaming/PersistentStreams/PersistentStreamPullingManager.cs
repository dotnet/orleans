...
namespace Orleans.Streams
{
    internal sealed partial class PersistentStreamPullingManager : SystemTarget, IPersistentStreamPullingManager, IStreamQueueBalanceListener
    {
        ...
        private readonly Dictionary<QueueId, PullingAgentTarget> queuesToAgentsMap;
        private readonly Dictionary<QueueId, PullingAgentTarget> deactivatedAgents = new();
            ...
            : base(managerId, shared)
        {
            ...
            queuesToAgentsMap = new Dictionary<QueueId, PullingAgentTarget>();
        ...
        private async Task AddNewQueues(IEnumerable<QueueId> myQueues, bool failOnInit, CancellationToken cancellationToken = default)
        {
            ...
            var agents = new List<PullingAgentTarget>();
        ...
        private async Task InitAgent(PullingAgentTarget agent, CancellationToken cancellationToken)
        {
        ...
        private async Task RemoveQueues(List<QueueId> queuesToRemove, CancellationToken cancellationToken = default)
        {
            ...
            var agents = new List<PullingAgentTarget>(queuesToRemove.Count);
        ...
        private readonly struct AgentsLogRecord(List<PullingAgentTarget> agents)
        {
