    ...
    public class GlobalConfiguration : MessagingConfiguration
    {
       ...
       /// <summary>
            ...
            : base(true)
        {
            ...
            this.LivenessEnabled = ClusteringOptions.DEFAULT_LIVENESS_ENABLED;
            this.ProbeTimeout = ClusteringOptions.DEFAULT_LIVENESS_PROBE_TIMEOUT;
            this.TableRefreshTimeout = ClusteringOptions.DEFAULT_LIVENESS_TABLE_REFRESH_TIMEOUT;
            this.DeathVoteExpirationTimeout = ClusteringOptions.DEFAULT_LIVENESS_DEATH_VOTE_EXPIRATION_TIMEOUT;
            this.IAmAliveTablePublishTimeout = ClusteringOptions.DEFAULT_LIVENESS_I_AM_ALIVE_TABLE_PUBLISH_TIMEOUT;
            this.NumMissedProbesLimit = ClusteringOptions.DEFAULT_LIVENESS_NUM_MISSED_PROBES_LIMIT;
            this.NumProbedSilos = ClusteringOptions.DEFAULT_LIVENESS_NUM_PROBED_SILOS;
            this.NumVotesForDeathDeclaration = ClusteringOptions.DEFAULT_LIVENESS_NUM_VOTES_FOR_DEATH_DECLARATION;
            this.NumMissedTableIAmAliveLimit = ClusteringOptions.DEFAULT_LIVENESS_NUM_TABLE_I_AM_ALIVE_LIMIT;
            this.UseLivenessGossip = ClusteringOptions.DEFAULT_LIVENESS_USE_LIVENESS_GOSSIP;
            this.ValidateInitialConnectivity = ClusteringOptions.DEFAULT_VALIDATE_INITIAL_CONNECTIVITY;
            this.MaxJoinAttemptTime = ClusteringOptions.DEFAULT_LIVENESS_MAX_JOIN_ATTEMPT_TIME;
