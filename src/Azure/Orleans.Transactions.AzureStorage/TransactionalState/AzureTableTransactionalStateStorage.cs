            ...
            try
            {
                ...
                else
                {
                    ...
                    for (var i = 0; i < states.Count; i++)
                    {
                        ...
                        var tm = JsonConvert.DeserializeObject<ParticipantId>(kvp.Value.TransactionManager, jsonSettings);
                    ...
                    var metadata = JsonConvert.DeserializeObject<TransactionalStateMetaData>(key.Metadata, jsonSettings);
