...
namespace Orleans.Streaming.EventHubs
{
    ...
    public class EventHubAdapterFactory : IQueueAdapterFactory, IQueueAdapter, IQueueAdapterCache
    {
        ...
        private void InitCheckpointerFactory() => this.checkpointerFactory = this.serviceProvider.GetRequiredServiceByName<IStreamQueueCheckpointerFactory>(this.Name);
        /// <summary>
        ...
        /// <returns></returns>
        public Task<IStreamFailureHandler> GetDeliveryFailureHandler(QueueId queueId) => this.StreamFailureHandlerFactory(this.streamQueueMapper.QueueToPartition(queueId));
        ...
        private EventHubAdapterReceiver GetOrCreateReceiver(QueueId queueId) => this.receivers.GetOrAdd(queueId, (q, instance) => instance.MakeReceiver(q), this);
