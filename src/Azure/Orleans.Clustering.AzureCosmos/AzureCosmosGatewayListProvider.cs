...
using Orleans.Clustering.AzureCosmos.Models;
...
internal class AzureCosmosGatewayListProvider : IGatewayListProvider
{
    ...
    private readonly AzureCosmosClusteringOptions _options;
    ...
    public AzureCosmosGatewayListProvider(
    ...
    {
        _logger = loggerFactory.CreateLogger<AzureCosmosGatewayListProvider>();
