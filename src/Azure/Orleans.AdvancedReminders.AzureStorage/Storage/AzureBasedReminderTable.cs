...
public sealed partial class AzureBasedReminderTable : IReminderTable
{
    ...
    internal ReminderTableData ConvertFromTableEntryList(List<(ReminderTableEntry Entity, string ETag)> entries)
    {
    ...
    private ReminderEntry ConvertFromTableEntry(ReminderTableEntry tableEntry, string eTag)
    {
        ...
        finally
        {
            ...
            if (!string.Equals(tableEntry.ServiceId, serviceIdStr, StringComparison.Ordinal))
            {
