...
public struct DurableTaskDiagnosticState
{
    ...
    /// <summary>
    /// Gets or sets the task status, or <see langword="null"/> when the field is absent from an older serialized payload.
    /// </summary>
    [Id(2)]
    ...
    /// <summary>
    /// Gets or sets the completion waiters, or <see langword="null"/> when the field is absent from an older serialized payload.
    /// </summary>
    [Id(5)]
