...
internal sealed partial class KubernetesClusterProvider : IClusterProvider
{
    ...
    [LoggerMessage(
        ...
        Message = $"Unable to monitor pods due to insufficient permissions. Ensure that this pod has an appropriate Kubernetes role binding. Grant the delete verb as well when DeleteDefunctSiloPods is enabled. Here is an example baseline role binding:\n{ExampleRoleBinding}"
    )]
