...
1. Following the philosophy of Orleans virtual actors, Orleans streams are *virtual*. That is, a stream always exists. It is not explicitly created or destroyed, and it can never fail.
