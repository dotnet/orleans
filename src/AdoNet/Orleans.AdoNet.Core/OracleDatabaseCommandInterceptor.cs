...
internal class OracleCommandInterceptor : ICommandInterceptor
{
    ...
    {
        var type = Type.GetType("Oracle.ManagedDataAccess.Client.OracleCommand, Oracle.ManagedDataAccess", true)!;
    ...
    {
        var type = Type.GetType("Oracle.ManagedDataAccess.Client.OracleParameter, Oracle.ManagedDataAccess", true)!;

        var parameterExpression = Expression.Parameter(typeof(IDbDataParameter), "dbparameter");

        var castExpression = Expression.Convert(parameterExpression, type);

        var enumType = Type.GetType("Oracle.ManagedDataAccess.Client.OracleDbType, Oracle.ManagedDataAccess", true)!;
