...
namespace Orleans.Hosting
{
    ...
    public static class SiloBuilderReminderExtensions
    {
        ...
        /// </remarks>
        public static ISiloBuilder UseAdoNetDurableReminderService(
            this ISiloBuilder builder,
            Action<AdoNetReminderTableOptions> configureOptions)
        {
            return builder.UseAdoNetDurableReminderService(ob => ob.Configure(configureOptions));
        }
        ...
        {
            return builder.ConfigureServices(services => services.UseAdoNetDurableReminderService(configureOptions));
        }
        ...
        /// Instructions on configuring your database are available at <see href="http://aka.ms/orleans-sql-scripts"/>.
        /// </remarks>
        public static IServiceCollection UseAdoNetDurableReminderService(this IServiceCollection services, Action<OptionsBuilder<AdoNetReminderTableOptions>> configureOptions)
        {
            services.AddDurableReminders();
            services.AddSingleton<Orleans.DurableReminders.IReminderTable, AdoNetReminderTable>();
