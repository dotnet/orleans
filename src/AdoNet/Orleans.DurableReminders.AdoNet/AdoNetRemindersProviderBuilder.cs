...
internal sealed class AdoNetRemindersProviderBuilder : IProviderBuilder<ISiloBuilder>
{
    ...
    {
        builder.UseAdoNetDurableReminderService((OptionsBuilder<AdoNetReminderTableOptions> optionsBuilder) => optionsBuilder.Configure<IServiceProvider>((options, services) =>
            {
