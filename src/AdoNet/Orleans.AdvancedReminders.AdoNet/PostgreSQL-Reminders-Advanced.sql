...
CREATE INDEX IX_AdvancedReminders_NextDueUtc
    ON OrleansAdvancedRemindersTable(ServiceId, NextDueUtc);
    ...
    IF ExpectedVersionArg = -1 THEN
        INSERT INTO OrleansAdvancedRemindersTable AS reminder
            (ServiceId, GrainId, ReminderName, StartTime, Period, CronExpression, CronTimeZoneId,
             NextDueUtc, LastFireUtc, ScheduleId, JobId, JobShardId, Action, GrainHash, Version)
        VALUES
            (ServiceIdArg, GrainIdArg, ReminderNameArg, StartTimeArg, PeriodArg, CronExpressionArg, CronTimeZoneIdArg,
             NextDueUtcArg, LastFireUtcArg, ScheduleIdArg, JobIdArg, JobShardIdArg, ActionArg, GrainHashArg, 0)
