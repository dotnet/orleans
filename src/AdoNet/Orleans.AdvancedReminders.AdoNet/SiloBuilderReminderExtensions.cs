...
namespace Orleans.Hosting
{
    ...
    public static class SiloBuilderReminderExtensions
    {
        ...
        /// Instructions on configuring your database are available at <see href="http://aka.ms/orleans-sql-scripts"/>.
        /// </remarks>
        public static IServiceCollection UseAdoNetAdvancedReminderService(this IServiceCollection services, Action<OptionsBuilder<AdoNetReminderTableOptions>> configureOptions)
        {
            services.AddAdvancedReminders();
            services.AddSingleton<Orleans.AdvancedReminders.IReminderTable, AdoNetReminderTable>();
