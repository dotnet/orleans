...
namespace Orleans.Transactions.TestKit
{
    ...
    public class PassOperation : ITransactionCommitOperation<IRemoteCommitService>
    {
        ...
        public async Task<bool> Commit(Guid transactionId, IRemoteCommitService service) => await service.Pass(transactionId, this.Data);
    }
    ...
    public class FailOperation : ITransactionCommitOperation<IRemoteCommitService>
    {
        ...
        public async Task<bool> Commit(Guid transactionId, IRemoteCommitService service) => await service.Fail(transactionId, this.Data);
    }
    ...
    public class ThrowOperation : ITransactionCommitOperation<IRemoteCommitService>
    {
        ...
        public async Task<bool> Commit(Guid transactionId, IRemoteCommitService service) => await service.Throw(transactionId, this.Data);
    }
}
