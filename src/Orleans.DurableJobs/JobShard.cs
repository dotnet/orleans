...
public interface IJobShard : IAsyncDisposable
{
    ...
    IAsyncEnumerable<IDurableJobRun> ConsumeDurableJobsAsync();
    ...
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>A task that represents the asynchronous operation.</returns>
    Task RetryJobLaterAsync(IDurableJobRun jobContext, DateTimeOffset newDueTime, CancellationToken cancellationToken);
...
public abstract class JobShard : IJobShard
{
    ...
    /// <inheritdoc/>
    public IAsyncEnumerable<IDurableJobRun> ConsumeDurableJobsAsync()
    {
        return _jobQueue;
    }
    ...
    /// <inheritdoc/>
    public async Task RetryJobLaterAsync(IDurableJobRun jobContext, DateTimeOffset newDueTime, CancellationToken cancellationToken)
    {
