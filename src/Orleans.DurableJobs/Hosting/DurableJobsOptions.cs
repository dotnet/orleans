...
public sealed class DurableJobsOptions
{
    ...
    /// </summary>
    public Func<IDurableJobRun, Exception, DateTimeOffset?> ShouldRetry { get; set; } = DefaultShouldRetry;

    private static DateTimeOffset? DefaultShouldRetry(IDurableJobRun jobContext, Exception ex)
    {
