...
internal interface IDurableJobReceiverExtension : IGrainExtension
{
    ...
    Task DeliverDurableJobAsync(IDurableJobRun context, CancellationToken cancellationToken);
}
...
internal sealed partial class DurableJobReceiverExtension : IDurableJobReceiverExtension
{
    ...
    public async Task DeliverDurableJobAsync(IDurableJobRun context, CancellationToken cancellationToken)
    {
