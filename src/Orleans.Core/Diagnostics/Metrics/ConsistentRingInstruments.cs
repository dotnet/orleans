...
internal static class ConsistentRingInstruments
{
    ...
    {
        RingSize = Instruments.Meter.CreateObservableGauge(StatisticNames.CONSISTENTRING_RINGSIZE, observeValue);
    }
    ...
    {
        MyRangeRingPercentage = Instruments.Meter.CreateObservableGauge(StatisticNames.CONSISTENTRING_MYRANGE_RINGPERCENTAGE, observeValue);
    }
    ...
    {
        AverageRingPercentage = Instruments.Meter.CreateObservableGauge(StatisticNames.CONSISTENTRING_AVERAGERINGPERCENTAGE, observeValue);
    }
}
