...
internal static class ReminderInstruments
{
    ...
    public static void RegisterActiveRemindersObserve(Func<int> observeValue) => ActiveReminders = Instruments.Meter.CreateObservableGauge(InstrumentNames.REMINDERS_NUMBER_ACTIVE_REMINDERS, observeValue);
