...
internal static class CatalogInstruments
{
    ...
    internal static void ActivationShutdownViaApplication() => ActivationShutdown.Add(1, new KeyValuePair<string, object>("via", "application"));
    ...
    internal static void ActivationShutdownViaDeactivateStuckActivation() => ActivationShutdown.Add(1, new KeyValuePair<string, object>("via", "stuck"));
