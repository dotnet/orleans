...
namespace Orleans.Runtime
{
    ...
    internal interface IRuntimeClient
    {
        ...
        void SendRequest(GrainReference target, IInvokable request, IResponseCompletionSource? context, InvokeMethodOptions options, bool waitForCancellationAcknowledgement);
