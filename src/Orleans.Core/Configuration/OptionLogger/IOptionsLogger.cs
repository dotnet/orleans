...
{ 
    ...
    internal class ClientOptionsLogger : OptionsLogger, ILifecycleParticipant<IClusterClientLifecycle>
    {
        ...
        /// <inheritdoc />
        public void Participate(IClusterClientLifecycle lifecycle) => lifecycle.Subscribe<ClientOptionsLogger>(ClientOptionLoggerLifeCycleRing, OnStart);
    ...
    public abstract class OptionsLogger 
    {
        ...
        /// </summary>
        public void LogOptions() => LogOptions(services.GetServices<IOptionFormatter>());
