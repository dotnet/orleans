namespace Orleans.Hosting
{
    ...
    public static class ClientBuilderGrainCallFilterExtensions
    {
        ...
        public static IClientBuilder AddOutgoingGrainCallFilter(this IClientBuilder builder, IOutgoingGrainCallFilter filter) => builder.ConfigureServices(services => services.AddOutgoingGrainCallFilter(filter));
        ...
        /// <param name="filter">The filter.</param>
        /// <returns>The <see cref="IClientBuilder"/>.</returns>
        public static IClientBuilder AddOutgoingGrainCallFilter(this IClientBuilder builder, OutgoingGrainCallFilterDelegate filter) => builder.ConfigureServices(services => services.AddOutgoingGrainCallFilter(filter));
    }
}