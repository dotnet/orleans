...
internal partial class GoogleFirestoreGatewayListProvider : IGatewayListProvider
{
        ...
        IOptions<GatewayOptions> gatewayOptions)
    {
        ...
        this._logger = loggerFactory.CreateLogger<GoogleFirestoreGatewayListProvider>();
