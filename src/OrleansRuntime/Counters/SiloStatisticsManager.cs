...
namespace Orleans.Runtime.Counters
{
    internal class SiloStatisticsManager
    {
        ...
        public SiloStatisticsManager(SiloInitializationParameters initializationParams, SerializationManager serializationManager, ITelemetryClient telemetryClient)
        {
            ...
            this.countersPublisher = new CountersStatistics(initializationParams.NodeConfig.StatisticsPerfCountersWriteInterval, telemetryClient);
