...
public static class GrainReminderExtensions
{
    ...
    /// The grain must implement the <c>Orleans.DurableReminders.IRemindable</c> interface, and reminders for this grain will be sent to the <c>ReceiveReminder</c> callback method.
