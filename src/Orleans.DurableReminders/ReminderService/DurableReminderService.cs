...
internal sealed class DurableReminderService : IReminderService, ILifecycleParticipant<ISiloLifecycle>
{
    ...
    private readonly ILogger<DurableReminderService> _logger;
    private readonly ReminderOptions _options;

    public DurableReminderService(
        IReminderTable reminderTable,
        ILocalDurableJobManager jobManager,
        IGrainFactory grainFactory,
        IOptions<ReminderOptions> options,
        ILogger<DurableReminderService> logger)
    {
    ...
    public async Task UnregisterReminder(IGrainReminder reminder)
    {
        ...
        {
            throw new ArgumentException("Reminder handle was not created by Orleans.DurableReminders.", nameof(reminder));
        }
    ...
    private async Task ScheduleReminderAsync(ReminderEntry entry, CancellationToken cancellationToken)
    {
        ...
        var dispatcher = _grainFactory.GetGrain<IDurableReminderDispatcherGrain>(GetDispatcherKey(entry.GrainId));
