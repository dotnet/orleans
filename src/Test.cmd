...
set TESTS=%OutDir%\Tester.dll,%OutDir%\TesterInternal.dll,%OutDir%\Orleans.NonSiloTests.dll,%OutDir%\Tester.AzureUtils.dll,%OutDir%\Tester.SQLUtils.dll,%OutDir%\DefaultCluster.Tests.dll,%OutDir%\BondUtils.Tests.dll,%OutDir%\GoogleUtils.Tests.dll,%OutDir%\PSUtils.Tests.dll,%OutDir%\ServiceBus.Tests.dll,%OutDir%\TestServiceFabric.dll
