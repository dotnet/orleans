...
internal class DisabledTransactionAgent : ITransactionAgent
{
    ...
    public Task<TransactionInfo> StartTransaction(bool readOnly, TimeSpan timeout) => throw new OrleansStartTransactionFailedException(new OrleansTransactionsDisabledException());
    public Task Transaction(TransactionOption transactionOption, Func<Task> scope) => throw new OrleansTransactionsDisabledException();
}
