...
namespace Orleans.Runtime
{
    internal class Constants
    {
        ...
        public static readonly GrainId DirectoryServiceId = GrainIdFactory.GetSystemTargetGrainId(10);
        public static readonly GrainId DirectoryCacheValidatorId = GrainIdFactory.GetSystemTargetGrainId(11);
        public static readonly GrainId SiloControlId = GrainIdFactory.GetSystemTargetGrainId(12);
        public static readonly GrainId ClientObserverRegistrarId = GrainIdFactory.GetSystemTargetGrainId(13);
        public static readonly GrainId CatalogId = GrainIdFactory.GetSystemTargetGrainId(14);
        public static readonly GrainId MembershipOracleId = GrainIdFactory.GetSystemTargetGrainId(15);
        public static readonly GrainId TypeManagerId = GrainIdFactory.GetSystemTargetGrainId(17);
        public static readonly GrainId ProviderManagerSystemTargetId = GrainIdFactory.GetSystemTargetGrainId(19);
        public static readonly GrainId DeploymentLoadPublisherSystemTargetId = GrainIdFactory.GetSystemTargetGrainId(22);
        public static readonly GrainId MultiClusterOracleId = GrainIdFactory.GetSystemTargetGrainId(23);
        public static readonly GrainId ClusterDirectoryServiceId = GrainIdFactory.GetSystemTargetGrainId(24);
        public static readonly GrainId StreamProviderManagerAgentSystemTargetId = GrainIdFactory.GetSystemTargetGrainId(25);
        public static readonly GrainId TestHooksSystemTargetId = GrainIdFactory.GetSystemTargetGrainId(26);
        public static readonly GrainId ProtocolGatewayId = GrainIdFactory.GetSystemTargetGrainId(27);
        public static readonly GrainId TransactionAgentSystemTargetId = GrainIdFactory.GetSystemTargetGrainId(28);
        ...
        public static readonly GrainId SystemMembershipTableId = GrainIdFactory.GetSystemGrainId(new Guid("01145FEC-C21E-11E0-9105-D0FB4724019B"));
        public static readonly GrainId SiloDirectConnectionId = GrainIdFactory.GetSystemGrainId(new Guid("01111111-1111-1111-1111-111111111111"));
