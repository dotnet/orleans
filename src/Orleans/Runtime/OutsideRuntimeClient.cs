    ...
    internal class OutsideRuntimeClient : IRuntimeClient, IDisposable, IClusterConnectionStatusListener
    {
	 ...
	 //   private readonly ActionBlock<Message> messageHandler;
        ...
        private async Task StartInternal()
        {
            ...
            transport.AddShortCicruitTargetBlock(Message.Categories.Application, message => ThreadPool.UnsafeQueueUserWorkItem(msgHandler, message)); // tdo: dispatch to somewhere

            transport.AddTargetBlock(Message.Categories.Application, message => ThreadPool.UnsafeQueueUserWorkItem(msgHandler, message)); // tdo: dispatch to somewhere
