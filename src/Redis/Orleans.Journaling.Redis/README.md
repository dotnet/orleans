...
This alpha layout replaces the hash-only key layout. There is no legacy-key discovery, decoder, or migration path; use a fresh key prefix when changing layouts.
