...
/// </summary>
/// <remarks>
/// The extent writer is caller-owned and may be reused after a successful append or replace
...
public interface IStateMachineLogExtentWriter : IDisposable
{
    ...
    /// <summary>
    /// Clears all buffered data so the writer can be reused for another extent.
    /// </summary>
    void Reset();
}
