...
/// services.AddSingleton&lt;ILogValueCodec&lt;MyEntity&gt;, MyEntityCodec&gt;();
///
/// // Register an open-generic codec for all types (e.g., JSON-based)
/// services.AddSingleton(typeof(ILogValueCodec&lt;&gt;), typeof(JsonLogValueCodec&lt;&gt;));
/// </code>
/// </example>
/// </remarks>
public interface ILogValueCodec<T>
{
    /// <summary>
