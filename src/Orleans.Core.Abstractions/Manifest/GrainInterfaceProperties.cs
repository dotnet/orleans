...
namespace Orleans.Metadata
{
    ...
    public sealed class DefaultGrainTypeAttribute : Attribute, IGrainInterfacePropertiesProviderAttribute
    {
        ...
        /// <inheritdoc />
        void IGrainInterfacePropertiesProviderAttribute.Populate(IServiceProvider services, Type type, Dictionary<string, string> properties) => properties[WellKnownGrainInterfaceProperties.DefaultGrainType] = this.grainType;
    }
}