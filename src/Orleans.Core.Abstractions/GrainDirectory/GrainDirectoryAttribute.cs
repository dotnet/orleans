...
namespace Orleans.GrainDirectory
{
    ...
    public sealed class GrainDirectoryAttribute : Attribute, IGrainPropertiesProviderAttribute
    {
        ...
        {
            GrainDirectoryName = grainDirectoryName;
        }
        ...
        /// <inheritdoc />
        public void Populate(IServiceProvider services, Type grainClass, GrainType grainType, Dictionary<string, string> properties) => properties[WellKnownGrainTypeProperties.GrainDirectory] = GrainDirectoryName ?? DEFAULT_GRAIN_DIRECTORY;
    }
}
