...
namespace Orleans.Placement
{
    ...
    public abstract class PlacementAttribute : Attribute, IGrainPropertiesProviderAttribute
    {
        ...
        /// <inheritdoc />
        public virtual void Populate(IServiceProvider services, Type grainClass, GrainType grainType, Dictionary<string, string> properties) => this.PlacementStrategy?.PopulateGrainProperties(services, grainClass, grainType, properties);
    }
