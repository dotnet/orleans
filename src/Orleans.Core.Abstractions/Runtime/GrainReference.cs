...
namespace Orleans.Runtime
{
    ...
    public class GrainReference : IAddressable, IEquatable<GrainReference>, ISpanFormattable
    {
        ...
        protected ValueTask<T> InvokeAsync<T>(IRequest methodDescription) => this.Runtime.InvokeMethodAsync<T>(this, methodDescription, methodDescription.Options);
        ...
        protected ValueTask InvokeAsync(IRequest methodDescription) => this.Runtime.InvokeMethodAsync(this, methodDescription, methodDescription.Options);
