...
namespace Orleans.Runtime
{
    ...
    public abstract class GrainService : SystemTarget, IRingRangeListener, IGrainService
    {
        ...
        /// <inheritdoc/>
        void IRingRangeListener.RangeChangeNotification(IRingRange oldRange, IRingRange newRange, bool increased) => WorkItemGroup.QueueTask(() => OnRangeChange(oldRange, newRange, increased), this).Ignore();
