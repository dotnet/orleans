...
public sealed class ResourceOptimizedPlacementOptions
{
    ...
    /// </summary>
    /// <remarks><i>Valid range of values are [0.00-1.00]</i></remarks>
    public float CpuUsageWeight { get; set; } = DEFAULT_CPU_USAGE_WEIGHT;
    /// <summary>
    /// The default value of <see cref="CpuUsageWeight"/>.
    /// </summary>
    public const float DEFAULT_CPU_USAGE_WEIGHT = 0.34f;
    ...
    /// </summary>
    public const float DEFAULT_MEMORY_USAGE_WEIGHT = 0.33f;
    ...
    /// </summary>
    public const float DEFAULT_AVAILABLE_MEMORY_WEIGHT = 0.33f;
