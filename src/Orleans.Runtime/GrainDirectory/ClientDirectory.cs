...
namespace Orleans.Runtime.GrainDirectory
{
    ...
    internal sealed class ClientDirectory : SystemTarget, ILocalClientDirectory, IRemoteClientDirectory, ILifecycleParticipant<ISiloLifecycle>
    {
        ...
        internal class TestAccessor
        {
            ...
            public bool ShouldPublish() => _instance.ShouldPublish();
            public ImmutableDictionary<SiloAddress, (ImmutableHashSet<GrainId> ConnectedClients, long Version)> CurrentTable { get => _instance._table; set => _instance._table = value; }
            public long Version { get => _instance._localVersion; set => _instance._localVersion = value; }
            ...
            public SiloAddress PreviousSuccessor { get => _instance._previousSuccessor; set => _instance._previousSuccessor = value; }
            public ImmutableDictionary<SiloAddress, (ImmutableHashSet<GrainId> ConnectedClients, long Version)> PreviousPublishedTable { get => _instance._publishedTable; set => _instance._publishedTable = value; }
        }
    }
}
