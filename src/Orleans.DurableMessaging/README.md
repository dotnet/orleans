...
- `IInboxHandler` and `IInboxHandler<TMessage>` define metadata selection and message
  handling. `RouteKeyHandler`, `RoutePrefixHandler`, and `CorrelationHandler` match
  exact ordinal routes, route prefixes at segment boundaries, and correlation
