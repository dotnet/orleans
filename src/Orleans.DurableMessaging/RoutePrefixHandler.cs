...
/// For example, a prefix of "rpc/" matches "rpc/request", "rpc/reply", and "rpc/anything".
...
/// proper boundary matching. For example, "rpc" becomes "rpc/". This prevents false matches
...
///     {
///         // Handle RPC request
///         if (!context.Envelope.Data.TryGetBody&lt;RpcRequest&gt;(out var request))
///         {
...
public abstract class RoutePrefixHandler : IInboxHandler
{
    ...
    /// <remarks>
    /// <para>
    /// For example, if the prefix is "rpc/" and the route key is "rpc/request",
    /// this method returns "request".
    /// </para>
    /// <para>
