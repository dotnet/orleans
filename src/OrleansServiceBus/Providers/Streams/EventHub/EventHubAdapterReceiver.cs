...
namespace Orleans.ServiceBus.Providers
{
    ...
    internal class EventHubAdapterReceiver : IQueueAdapterReceiver, IQueueCache
    {
        ...
        private readonly Func<string, IStreamQueueCheckpointer<string>, Logger, ITelemetryClient, IEventHubQueueCache> cacheFactory;
        ...
        private Func<EventHubPartitionSettings, string, Logger, ITelemetryClient, Task<IEventHubReceiver>> eventHubReceiverFactory;
        ...
        public EventHubAdapterReceiver(EventHubPartitionSettings settings,
            Func<string, IStreamQueueCheckpointer<string>, Logger, ITelemetryClient, IEventHubQueueCache> cacheFactory,
            ...
            Func<EventHubPartitionSettings, string, Logger, ITelemetryClient, Task<IEventHubReceiver>> eventHubReceiverFactory = null)
        {
        ...
        private async Task Initialize()
        {
            ...
            try
            {
                ...
                cache = cacheFactory(settings.Partition, checkpointer, baseLogger, this.telemetryClient);
                ...
                receiver = await this.eventHubReceiverFactory(settings, offset, logger, this.telemetryClient);
                watch.Stop();
        ...
        private static async Task<IEventHubReceiver> CreateReceiver(EventHubPartitionSettings partitionSettings, string offset, Logger logger, ITelemetryClient telemetryClient)
        {
