...
namespace Orleans.Providers.GCP.Streams.PubSub
{
        ...
        where TDataAdapter : IPubSubDataAdapter
    {
        ...
        public IQueueAdapterReceiver CreateReceiver(QueueId queueId) => PubSubAdapterReceiver.Create(this.loggerFactory, queueId, ProjectId, TopicId, ServiceId, _dataAdapter, Deadline, _customEndpoint);
