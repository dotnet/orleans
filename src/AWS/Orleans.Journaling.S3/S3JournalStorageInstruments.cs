...
internal static class S3JournalStorageInstruments
{
    ...
    private static readonly Counter<long> Operations = Instruments.Meter.CreateCounter<long>("orleans-journaling-s3-operations");
    private static readonly Counter<long> OperationBytes = Instruments.Meter.CreateCounter<long>("orleans-journaling-s3-operation-bytes", BytesUnit);
    private static readonly Histogram<double> OperationDuration = Instruments.Meter.CreateHistogram<double>("orleans-journaling-s3-operation-duration", MillisecondsUnit);
