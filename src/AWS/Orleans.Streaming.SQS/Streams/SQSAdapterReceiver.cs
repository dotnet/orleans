    ...
    internal class SQSAdapterReceiver : IQueueAdapterReceiver
    {
        ...
        public async Task<IList<IBatchContainer>> GetQueueMessagesAsync(int maxCount)
        {
            try
            {
                ...
                var messageBatch = messages
                    .Select(msg => (IBatchContainer)SQSBatchContainer.FromSQSMessage(serializer, msg, lastReadMessage++)).ToList();
        ...
        public async Task MessagesDeliveredAsync(IList<IBatchContainer> messages)
        {
            try
            {
                ...
                var cloudQueueMessages = messages.Cast<SQSBatchContainer>().Select(b => b.Message).ToList();
