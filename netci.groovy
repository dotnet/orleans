...
Utilities.addXUnitDotNETResults(commitJob, 'src/TestResults/xUnit-Results.xml')
Utilities.addMSTestResults(commitJob, 'src/TestResults/*.trx')
...
Utilities.addXUnitDotNETResults(PRJob, 'src/TestResults/xUnit-Results.xml')
Utilities.addMSTestResults(PRJob, 'src/TestResults/*.trx')