...
.DESCRIPTION
    ...
    that they target net10.0 and reference Orleans 10.2.2 packages, and builds each project.
...
function Build-Project {
    ...
    $output = & dotnet build $ProjectPath --framework net10.0 --nologo -v q 2>&1
