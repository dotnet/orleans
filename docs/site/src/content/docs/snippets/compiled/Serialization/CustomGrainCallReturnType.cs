...
#region cross_assembly_registration
[assembly: InvokableBaseType(
    typeof(GrainReference),
    typeof(Serialization.GrainCall<>),
    typeof(Serialization.GrainCallRequest<>))]
#endregion

namespace Serialization;

#region grain_call_return_type
[InvokableBaseType(
    typeof(GrainReference),
    typeof(GrainCall<>),
