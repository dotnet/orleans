...
description: Start with the canonical Orleans 10 beginner quickstart.
ms.date: 08/02/2026
ms.topic: tutorial
---
...
The former four-project minimal tutorial duplicated the same concepts as the current beginner experience while requiring extra project structure.

Follow [Build your first Orleans app](../quickstarts/build-your-first-orleans-app.md) for the canonical Orleans 10 walkthrough. It covers hosting a silo, defining and implementing a grain, obtaining a grain reference, and persisting state from ASP.NET Core.
