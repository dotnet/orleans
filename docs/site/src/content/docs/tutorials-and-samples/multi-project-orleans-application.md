---
title: 'Tutorial: Create a multi-project Orleans application'
description: Build an Orleans silo and external client with separate grain contract and implementation projects.
ms.date: 08/08/2026
ms.topic: tutorial
---
...
:::code source="snippets/minimal/GrainInterfaces/IHello.cs" id="grain-interface":::
...
:::code source="snippets/minimal/Grains/HelloGrain.cs" id="grain-implementation":::
