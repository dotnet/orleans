...
- To learn how contracts, grain implementations, silos, and external clients fit into separate projects, follow [Create a multi-project Orleans application](tutorial-1.md).
