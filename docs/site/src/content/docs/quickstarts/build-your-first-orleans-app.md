...
description: Build a multi-project Orleans Hello World application.
ms.date: 08/08/2026
ms.topic: quickstart
ms.devlang: csharp
---
...
In this quickstart, you build a multi-project Hello World application and run your first grain call. The solution separates the grain contracts, grain implementations, silo, and external client so that their dependency and deployment boundaries are visible.
