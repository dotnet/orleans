...
namespace OrleansUnitTestContainer
{
    public partial class Main : Form
    {
        ...
        public Main()
        {
            ...
            FilterFlag = FilterFlag.ERROR | FilterFlag.WARNING;
        }
        ...
        private void openToolStripButton_Click_1(object sender, EventArgs e)
        {
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                RetreiveRecords(new FilterCriteria { endInterval = this.EndInterval, startInterval = this.StartInterval, filterFlag = this.FilterFlag });
            }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (IsANonHeaderLinkCell(e))
            {
                if (!((DataGridViewLinkCell)dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex]).LinkVisited)
                {
                    ...
                    //LogRecord logRecord = ((LogRecord[])logRecordBindingSource.DataSource)[e.RowIndex];
        ...
        private void RetreiveRecords(FilterCriteria filterCriteria)
        {
            ...
            Task task = new Task((obj) =>
            {
                ...
                ((LogFileProcessor)obj).ProcessLogFiles(openFileDialog1.FileNames, -1, cts.Token);
        ...
        private void dataGridView1_CellContextMenuStripNeeded(object sender, DataGridViewCellContextMenuStripNeededEventArgs e)
        {
            ...
            menu.Items.Add("Open log file at this location...");
