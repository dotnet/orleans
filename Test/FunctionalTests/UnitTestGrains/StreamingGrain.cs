...
namespace UnitTestGrains
{
    ...
    public class ProducerObserver : IProducerObserver
    {
        ...
        private ProducerObserver(Logger logger)
        {
            _logger = logger;
            _observer = null;
        ...
        public static ProducerObserver NewObserver(Logger logger)
        {
            if (null == logger)
                throw new ArgumentNullException("logger");
    ...
    public class Streaming_ProducerGrain : Grain<IStreaming_ProducerGrain_State>, IStreaming_ProducerGrain
    {
        private Logger _logger;
    ...
    public class Streaming_ConsumerGrain : Grain<IStreaming_ConsumerGrain_State>, IStreaming_ConsumerGrain    
    {
        private Logger _logger;
...
#pragma warning disable 414
    [ImplicitStreamSubscription("TestNamespace1")]
    public class Streaming_ImplicitlySubscribedGenericConsumerGrain<T> : Streaming_ImplicitlySubscribedConsumerGrainBase, IStreaming_ImplicitlySubscribedConsumerGrain
    {}
}