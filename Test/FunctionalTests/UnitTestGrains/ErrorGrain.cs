...
namespace UnitTestGrains
{
    ...
    public class ErrorGrain : UnitTests.Grains.SimpleGrain, IErrorGrain
    {
        ...
        {
            logger = GetLogger(String.Format("ErrorGrain-{0}-{1}-{2}", base.RuntimeIdentity, base.Identity, base.Data.ActivationId.ToString()));
        ...
        public Task<int> UnobservedErrorContinuation2()
        {
            ...
            // the grain method returns OK, but leaves some unobserved promise
            Task<long> promise = Task<long>.FromResult((long)25);
