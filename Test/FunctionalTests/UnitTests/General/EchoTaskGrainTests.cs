...
namespace UnitTests.General
{
    ...
    public class EchoTaskGrainTests : UnitTestBase
    {
        ...
        [TestMethod, TestCategory("Nightly"), TestCategory("Echo")]
        ...
        [TestMethod, TestCategory("Nightly"), TestCategory("Echo"), TestCategory("Timeout")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Nightly"), TestCategory("Echo")]
