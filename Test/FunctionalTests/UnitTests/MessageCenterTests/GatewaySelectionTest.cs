...
namespace UnitTests.MessageCenterTests
{
    ...
    public class GatewaySelectionTest
    {
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Nightly"), TestCategory("Gateway")]
        ...
        [TestMethod, TestCategory("BVT"), TestCategory("Nightly"), TestCategory("Gateway"), TestCategory("SqlServer")]
        public async Task GatewaySelection_SqlServer()
        {
            ...
            SqlMembershipTable membership = await SqlMembershipTable.GetMembershipTable(cfg, true);
            ...
            foreach (Uri gateway in gatewayAddressUris)
            {
                ...
                var tableVersion = new TableVersion(count, SqlMembershipTable.NewEtag());
