...
namespace UnitTests.Streaming
{
    public class SingleStreamTestRunner
    {
        ...
        private async Task AssertProducerCount(int expectedCount, string providerName, Guid streamId)
        {
            ...
            {
                var actualCount = await ClientProviderRuntime.Instance.PubSub(StreamPubSubType.GrainBased).ProducerCount(streamId, providerName, UnitTestStreamNamespace.DefaultStreamNamespace);
        ...
        {
            var rendez = PubSubRendezvousGrainFactory.GetGrain(streamId, providerName);
