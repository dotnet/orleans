...
namespace OrleansRules
{
    public abstract class OrleansCustomRuleBase : BaseIntrospectionRule
    {
        ...
        static HashSet<TypeNode> s_discoveredTypes = new HashSet<TypeNode>();
    ...
    public class EnforcePromiseWait : OrleansCustomRuleBase
    {
        ...
        {
            VisitStatements(branch.Target.Statements);
        ...
        public override void VisitAssignmentStatement(AssignmentStatement assignment)
        {
            if (assignment.Target.Type.Name.Name.Contains("AsyncValue"))
            {
                ...
                //Console.Out.WriteLine("Local name: " + assignment.Target.Name.Name);
            }
        ...
        public override void VisitExpressionStatement(ExpressionStatement statement)
        {
            ...
            if (call != null)
            {
                ...
                if (binding != null)
                {
                    ...
                    else if (call.Type.Name.Name.StartsWith("AsyncValue"))
                    {
        ...
        public override void VisitReturn(ReturnNode returnInstruction)
        {
            ...
            if (returnExpression != null && returnExpression.Type.Name.Name.StartsWith("AsyncValue"))
            {
        ...
        public override ProblemCollection Check(ModuleNode module)
        {
            ...
            {
                /*
                if (Suppressible && IsSuppressed(type))
                {
                    // this rule is being suppressed
                    continue;
                }
                */
                ...
                foreach (var member in type.Members)
                {
                    ...
                    /*
                    if (Suppressible && IsSuppressed(member))
                    {
                        // this rule is being suppressed
                        continue;
                    }
