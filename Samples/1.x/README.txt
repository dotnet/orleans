...
Here <DOMAIN\user> is the account for which reservation is being made, such the one reported by "whoami". Localport number is the port to open for use. These show up in XML configuration files.
