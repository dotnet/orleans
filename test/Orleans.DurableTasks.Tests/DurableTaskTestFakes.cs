...
/// </summary>
[GenerateSerializer]
[Alias("Orleans.DurableTasks.Tests.TestDurableTaskRequest")]
internal sealed class TestDurableTaskRequest : IDurableTaskRequest
{
    ...
    public string GetInterfaceName() => "Orleans.DurableTasks.Tests.ITestInterface";

    public string GetActivityName() => "Orleans.DurableTasks.Tests.ITestInterface/TestMethod";
...
internal sealed class FakeGrainReferenceObserver(GrainReferenceShared shared, IdSpan key) : GrainReference(shared, key), IDurableTaskObserver
{
    ...
    public static FakeGrainReferenceObserver Create(IServiceProvider serviceProvider, string grainType, string key)
    {
        ...
        var shared = new GrainReferenceShared(
            ...
            GrainInterfaceType.Create("Orleans.DurableTasks.Tests.IDurableTaskObserverGrainExtension"),
            interfaceVersion: 0,
            runtime,
