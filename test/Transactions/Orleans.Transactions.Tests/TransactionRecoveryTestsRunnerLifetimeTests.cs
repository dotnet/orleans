...
public class TransactionRecoveryTestsRunnerLifetimeTests
{
    ...
    private static TransactionRecoveryEventObserver.RecoveryTransition CreateTransition() =>
        new(
            ...
            TransactionRecoveryEventObserver.RecoveryTransitionKind.TransactionConfirmCompleted,
            TransactionIds: [],
            TransactionDiagnosticEvents.TransactionProtocolRole.RemoteParticipant,
            TransactionDiagnosticEvents.TransactionPhase.Confirm,
            ResourceName: "test",
            GrainId: null,
            SiloAddress: null,
