...
namespace Tester.AzureUtils.Migration.Grains
{
    ...
    public interface ISimplePersistentMigrationWithIpEndpointGrain : ISimplePersistentMigrationGrain
    {
        Task SetIpEndpoint();
    ...
    [Serializable]
    public class MigrationTestGrainWithIpEndpoint_State
    {
        public int A { get; set; }
        public int B { get; set; }
    ...
    [Orleans.Persistence.Cosmos.GrainType("migrationtestgrainwithipendpoint")]
    public class MigrationTestGrainStorageWithIpEndpoint : Grain<MigrationTestGrainWithIpEndpoint_State>, ISimplePersistentMigrationWithIpEndpointGrain
    {
        private ILogger logger;
        private Guid version;

        public MigrationTestGrainStorageWithIpEndpoint(ILoggerFactory loggerFactory)
        {
        ...
        public Task SetIpEndpoint()
        {
            State.Endpoint = new IPEndPoint(IPAddress.Loopback, 12345);
            return WriteStateAsync();
        }

        public Task<IPEndPoint> GetEndpoint()
        {
            return Task.FromResult(State.Endpoint);
        }
