...
namespace UnitTests.Grains
{
    public class ServiceType : Grain, IServiceType
    {
        ...
        public Task<string> ServiceTypeMethod1() => Task.FromResult("ServiceTypeMethod1");

        public Task<string> ServiceTypeMethod2() => Task.FromResult("ServiceTypeMethod2");

        public Task<string> ServiceTypeMethod3() => Task.FromResult("ServiceTypeMethod3");
    }
}
