...
namespace UnitTests.Grains
{
    ...
    public class SlowConsumingGrain : Grain, ISlowConsumingGrain
    {
        ...
        public Task<int> GetNumberConsumed() => Task.FromResult(ConsumerObserver.NumConsumed);
    ...
    public class SlowObserver<T> : IAsyncObserver<T>
    {
        ...
        public async Task OnNextAsync(T item, StreamSequenceToken token = null)
        {
            ...
            else
            {
                ...
                slowConsumingGrain.ConsumerHandle = await slowConsumingGrain.ConsumerHandle.ResumeAsync(slowConsumingGrain.ConsumerObserver, firstToken);
            }
