...
namespace ServiceBus.Tests.StreamingTests
{
    ...
    public class EHPersistentStreamQueueRebalancingTests : PersistentStreamQueueRebalancingTestRunner, IClassFixture<EHPersistentStreamQueueRebalancingTests.Fixture>
    {
        private const string StreamProviderName = "foo";
        private const string EHPath = "ehorleanstest";
        private const string EHConsumerGroup = "orleansnightly";

        public EHPersistentStreamQueueRebalancingTests(Fixture fixture, ITestOutputHelper output)
        ...
        public class Fixture : BaseTestClusterFixture
        {
            ...
            private class MySiloBuilderConfigurator : ISiloBuilderConfigurator
            {
                ...
                {
                    ConfigureSiloHostBuilder(hostBuilder)
