...
[TestCategory("Reminders"), TestCategory("AzureCosmosDB")]
public class ReminderTests_AzureCosmos : ReminderTests_Base, IClassFixture<ReminderTests_AzureCosmos.Fixture>
{
    public class Fixture : BaseTestClusterFixture
    {
        protected override void CheckPreconditionsOrThrow() => AzureCosmosTestUtils.CheckCosmosDbStorage();
    ...
    public class SiloConfigurator : ISiloConfigurator
    {
        ...
        {
            hostBuilder.UseAzureCosmosReminderService(options =>
            {
    ...
    public ReminderTests_AzureCosmos(Fixture fixture) : base(fixture)
    {
