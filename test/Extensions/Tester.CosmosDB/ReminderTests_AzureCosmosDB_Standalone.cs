...
public class ReminderTests_AzureCosmosDB_Standalone
{
    ...
    public ReminderTests_AzureCosmosDB_Standalone(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
        ...
        this.log = this.loggerFactory.CreateLogger<ReminderTests_AzureCosmosDB_Standalone>();
    ...
    public async Task Reminders_AzureTable_InsertRate()
    {
        ...
        var storageOptions = Options.Create(new AzureCosmosDBReminderTableOptions());
        storageOptions.Value.ConfigureTestDefaults();

        IReminderTable table = new AzureCosmosDBReminderTable(this.loggerFactory, this.fixture.Services, storageOptions, clusterOptions);
        await table.Init();
        ...
        try
        {
            ...
            for (int i = 0; i < numOfInserts; i++)
            {
                ...
                var e = new ReminderEntry
                {
                    ...
                    GrainId = this.fixture.InternalGrainFactory.GetGrain(LegacyGrainId.NewId()).GetGrainId(),
