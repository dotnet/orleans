...
public class ReminderTests_AzureCosmosDB : ReminderTests_Base, IClassFixture<ReminderTests_AzureCosmosDB.Fixture>
{
    public class Fixture : BaseTestClusterFixture
    {
        protected override void CheckPreconditionsOrThrow() => CosmosDBTestUtils.CheckCosmosDbStorage();
    ...
    public class SiloConfigurator : ISiloConfigurator
    {
        ...
        {
            hostBuilder.UseCosmosDBReminderService(options =>
            {
    ...
    public ReminderTests_AzureCosmosDB(Fixture fixture) : base(fixture)
    {
