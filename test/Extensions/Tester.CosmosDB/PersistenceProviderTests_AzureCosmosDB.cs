...
[TestCategory("Persistence"), TestCategory("AzureCosmosDB")]
public class PersistenceProviderTests_AzureCosmosDB
{
    ...
    public PersistenceProviderTests_AzureCosmosDB(ITestOutputHelper output, TestEnvironmentFixture fixture)
    {
    ...
    private async Task<AzureCosmosDBStorage> InitAzureCosmosDBGrainStorage()
    {
        var options = new AzureCosmosDBStorageOptions();
        ...
        var store = ActivatorUtilities.CreateInstance<AzureCosmosDBStorage>(this.providerRuntime.ServiceProvider, options, clusterOptions, "TestStorage", pkProvider);
