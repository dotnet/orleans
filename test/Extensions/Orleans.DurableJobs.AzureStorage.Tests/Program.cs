    ...
    public static async Task<int> Main(string[] args)
    {
        if (args.Length == 0 || !int.TryParse(args[0], out _))
        {
            return await (args.Any(arg => arg is "-automated" or "@@")
                ...
                : Xunit.MicrosoftTestingPlatform.TestPlatformTestFramework.RunAsync(args, global::Orleans.DurableJobs.AzureStorage.Tests.SelfRegisteredExtensions.AddSelfRegisteredExtensions));
        }
