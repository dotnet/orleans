...
public sealed class RedisClientStreamTests : TestClusterPerTest
{
    ...
    [SkippableFact]
    public async Task RedisStreamProducerOnDroppedClientTest()
    {
        logger.LogInformation("************************ RedisStreamProducerOnDroppedClientTest *********************************");
        await _runner.StreamProducerOnDroppedClientTest(STREAM_PROVIDER_NAME, StreamNamespace);
    }
}
