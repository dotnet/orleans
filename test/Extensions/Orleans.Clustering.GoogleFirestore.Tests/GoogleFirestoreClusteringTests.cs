...
public class GoogleFirestoreClusteringTests : IAsyncLifetime
{
    ...
    private GoogleFirestoreMembershipTable _membershipTable = default!;
    private GoogleFirestoreGatewayListProvider _gatewayProvider = default!;
    ...
    public async Task InitializeAsync()
    {
        ...
        this._membershipTable = new GoogleFirestoreMembershipTable(
            NullLoggerFactory.Instance,
            firestoreOptions,
            clusterOptions);
        await this._membershipTable.InitializeMembershipTable(tryInitTableVersion: true);

        this._gatewayProvider = new GoogleFirestoreGatewayListProvider(
            NullLoggerFactory.Instance,
            firestoreOptions,
            clusterOptions,
