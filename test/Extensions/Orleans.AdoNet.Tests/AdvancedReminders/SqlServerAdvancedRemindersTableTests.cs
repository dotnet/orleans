...
{
    public SqlServerAdvancedRemindersTableTests(ConnectionStringFixture fixture, TestEnvironmentFixture environment)
    ...
    private static LoggerFilterOptions CreateFilters()
    {
        ...
        filters.AddFilter(nameof(SqlServerAdvancedRemindersTableTests), LogLevel.Trace);
        return filters;
    }
