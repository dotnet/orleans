...
public class MySqlDurableRemindersTableTests : DurableReminderTableTestsBase
{
    public MySqlDurableRemindersTableTests(ConnectionStringFixture fixture, TestEnvironmentFixture environment)
    ...
    private static LoggerFilterOptions CreateFilters()
    {
        ...
        filters.AddFilter(nameof(MySqlDurableRemindersTableTests), LogLevel.Trace);
        return filters;
    }
