...
namespace AWSUtils.Tests.MembershipTests
{
    ...
    public class DynamoDBMembershipTableTest : MembershipTableTestsBase, IClassFixture<DynamoDBStorageTestsFixture>
    {
        ...
        protected override IMembershipTable CreateMembershipTable(ILogger logger)
        {
            ...
            return new DynamoDBMembershipTable(loggerFactory, Options.Create(options), clusterOptions);
        }
        ...
        protected override IGatewayListProvider CreateGatewayListProvider(ILogger logger)
        {
            ...
            return new DynamoDBGatewayListProvider(loggerFactory.CreateLogger<DynamoDBGatewayListProvider>(), Options.Create(options), clusterOptions, gatewayOptions);
        }
