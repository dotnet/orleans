...
namespace OrleansCodeGen.TestProject
{
    ...
    internal sealed class Metadata_TestProject : global::Orleans.Serialization.Configuration.TypeManifestProviderBase
    {
        ...
        {
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_Invokable_IMyGrainWithGuidKey_GrainReference_8F0FEC0E));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_GrainWithGuidKey));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_Invokable_IMyGrainWithStringKey_GrainReference_43570316));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_GrainWithStringKey));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_Invokable_IMyGrainWithGuidCompoundKey_GrainReference_A9FEF7AF));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_GrainWithGuidCompoundKey));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_Invokable_IMyGrainWithIntegerCompoundKey_GrainReference_9814021A));
            AddImplementationType(config.Serializers, typeof(OrleansCodeGen.TestProject.Codec_GrainWithIntegerCompoundKey));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_Invokable_IMyGrainWithGuidKey_GrainReference_8F0FEC0E));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_GrainWithGuidKey));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_Invokable_IMyGrainWithStringKey_GrainReference_43570316));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_GrainWithStringKey));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_Invokable_IMyGrainWithGuidCompoundKey_GrainReference_A9FEF7AF));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_GrainWithGuidCompoundKey));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_Invokable_IMyGrainWithIntegerCompoundKey_GrainReference_9814021A));
            AddImplementationType(config.Copiers, typeof(OrleansCodeGen.TestProject.Copier_GrainWithIntegerCompoundKey));
            AddMetadataType(config.InterfaceProxies, typeof(OrleansCodeGen.TestProject.Proxy_IMyGrainWithGuidKey));
            AddMetadataType(config.InterfaceProxies, typeof(OrleansCodeGen.TestProject.Proxy_IMyGrainWithStringKey));
            AddMetadataType(config.InterfaceProxies, typeof(OrleansCodeGen.TestProject.Proxy_IMyGrainWithGuidCompoundKey));
            AddMetadataType(config.InterfaceProxies, typeof(OrleansCodeGen.TestProject.Proxy_IMyGrainWithIntegerCompoundKey));
            AddInterfaceType(config.Interfaces, typeof(global::TestProject.IMyGrainWithGuidKey));
            AddInterfaceType(config.Interfaces, typeof(global::TestProject.IMyGrainWithStringKey));
            AddInterfaceType(config.Interfaces, typeof(global::TestProject.IMyGrainWithGuidCompoundKey));
            AddInterfaceType(config.Interfaces, typeof(global::TestProject.IMyGrainWithIntegerCompoundKey));
            ...
            AddImplementationType(config.Activators, typeof(OrleansCodeGen.TestProject.Activator_GrainWithGuidKey));
            AddImplementationType(config.Activators, typeof(OrleansCodeGen.TestProject.Activator_GrainWithStringKey));
            AddImplementationType(config.Activators, typeof(OrleansCodeGen.TestProject.Activator_GrainWithGuidCompoundKey));
            AddImplementationType(config.Activators, typeof(OrleansCodeGen.TestProject.Activator_GrainWithIntegerCompoundKey));
