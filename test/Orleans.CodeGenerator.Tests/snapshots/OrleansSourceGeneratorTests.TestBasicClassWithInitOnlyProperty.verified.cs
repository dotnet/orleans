...
namespace OrleansCodeGen.TestProject
{
    ...
    internal sealed class Metadata_TestProject : global::Orleans.Serialization.Configuration.TypeManifestProviderBase
    {
        ...
        {
            config.AddSerializer(typeof(OrleansCodeGen.TestProject.Codec_DemoDataWithInitOnly));
            config.AddCopier(typeof(OrleansCodeGen.TestProject.Copier_DemoDataWithInitOnly));
            config.AddActivator(typeof(OrleansCodeGen.TestProject.Activator_DemoDataWithInitOnly));
        }
    }
}
