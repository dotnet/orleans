...
namespace DefaultCluster.Tests.General
{
    ...
    public class SimpleGrainTests : HostedTestClusterEnsureDefaultStarted
    {
        ...
        {
            var grain = this.GrainFactory.GetGrain<ISimpleGrain>(GetRandomGrainId(), grainClassNamePrefix: MultipleConstructorsSimpleGrain.MultipleConstructorsSimpleGrainPrefix);
