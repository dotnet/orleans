...
namespace DefaultCluster.Tests.General
{
    public class BasicActivationTests : HostedTestClusterEnsureDefaultStarted
    {
        ...
        public void BasicActivation_ActivateAndUpdate()
        {
            ...
            ITestGrain g1 = GrainFactory.GetGrain<ITestGrain>(g1Key);
            ITestGrain g2 = GrainFactory.GetGrain<ITestGrain>(g2Key);
            ...
            ITestGrain g1a = GrainFactory.GetGrain<ITestGrain>(g1Key);
        ...
        public void BasicActivation_Guid_ActivateAndUpdate()
        {
            ...
            IGuidTestGrain g1 = GrainFactory.GetGrain<IGuidTestGrain>(guid1);
            IGuidTestGrain g2 = GrainFactory.GetGrain<IGuidTestGrain>(guid2);
            ...
            IGuidTestGrain g1a = GrainFactory.GetGrain<IGuidTestGrain>(guid1);
            Assert.Equal("one", g1a.GetLabel().Result);
        }
        ...
        public async Task BasicActivation_Fail()
        {
            ...
            try
            {
                ...
                ITestGrain fail = GrainFactory.GetGrain<ITestGrain>(-2);
        ...
        public void BasicActivation_ULong_MaxValue()
        {
            ...
            ITestGrain g1 = GrainFactory.GetGrain<ITestGrain>(key1);
            ...
            ITestGrain g1a = GrainFactory.GetGrain<ITestGrain>((long)key1AsUlong);
        ...
        {
            ITestGrain simple = GrainFactory.GetGrain<ITestGrain>(GetRandomGrainId());
        ...
        public void BasicActivation_Reentrant_RecoveryAfterExpiredMessage()
        {
            ...
            TimeSpan prevTimeout = GetResponseTimeout();
            try
            {
                ...
                ITestGrain grain = GrainFactory.GetGrain<ITestGrain>(GetRandomGrainId());
                int num = 10;
        ...
        {
            ITestGrain g1 = GrainFactory.GetGrain<ITestGrain>(GetRandomGrainId());
