...
namespace DefaultCluster.Tests
{
    ...
    public class GrainReferenceCastTests : HostedTestClusterEnsureDefaultStarted
    {
        ...
        {
            GrainReference grain = (GrainReference)this.GrainFactory.GetGrain<ISimpleGrain>(ThreadSafeRandom.Next(), SimpleGrain.SimpleGrainNamePrefix);
        ...
        {
            IAddressable grain = this.GrainFactory.GetGrain<ISimpleGrain>(ThreadSafeRandom.Next(), SimpleGrain.SimpleGrainNamePrefix); ;
