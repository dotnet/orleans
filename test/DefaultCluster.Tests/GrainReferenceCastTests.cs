...
namespace DefaultCluster.Tests
{
    ...
    public class GrainReferenceCastTests : HostedTestClusterEnsureDefaultStarted
    {
        ...
        {
            var grain = (GrainReference)this.GrainFactory.GetGrain<ISimpleGrain>(Random.Shared.Next(), SimpleGrain.SimpleGrainNamePrefix);
        ...
        public void CastMultifacetRWReference()
        {
            ...
            var writer = this.GrainFactory.GetGrain<IMultifacetWriter>(1);
        ...
        public void CastMultifacetRWReferenceWaitForResolve()
        {
            ...
            var writer = this.GrainFactory.GetGrain<IMultifacetWriter>(2);
        ...
        public void CastInternalCastUpFromChild()
        {
            ...
            var grain = (GrainReference)this.GrainFactory.GetGrain<IGeneratorTestDerivedGrain1>(GetRandomGrainId());
        ...
        public async Task FailSideCastAfterResolve()
        {
            ...
            var grain = this.GrainFactory.GetGrain<IGeneratorTestDerivedGrain1>(GetRandomGrainId());
        ...
        public void CastGrainRefUpCastFromGrandchild()
        {
            ...
            GrainReference cast;
            var grain = (GrainReference)this.GrainFactory.GetGrain<IGeneratorTestDerivedDerivedGrain>(GetRandomGrainId());
