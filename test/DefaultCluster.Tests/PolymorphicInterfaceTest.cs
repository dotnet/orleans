...
namespace DefaultCluster.Tests.General
{
    public class PolymorphicInterfaceTest : HostedTestClusterEnsureDefaultStarted
    {
        ...
        public void Polymorphic_SimpleTest()
        {
            ...
            var IARef = this.GrainFactory.GetGrain<IA>(GetRandomGrainId(), grainFullName);
        ...
        {
            var grainFullName = typeof(PolymorphicTestGrain).FullName;
            var ICRef = this.GrainFactory.GetGrain<IC>(GetRandomGrainId(), grainFullName);
            ...
            var IFRef = this.GrainFactory.GetGrain<IF>(GetRandomGrainId(), grainFullName);
        ...
        public void Polymorphic__DerivedServiceType()
        {
            ...
            var derivedRef = this.GrainFactory.GetGrain<IDerivedServiceType>(GetRandomGrainId(), grainFullName);
