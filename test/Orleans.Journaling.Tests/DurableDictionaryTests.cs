...
public class DurableDictionaryTests : JournalingTestBase
{
    ...
    public async Task DurableDictionary_BasicOperations_Test()
    {
        ...
        var dictionary = new DurableDictionary<string, int>("testDict", sut.Manager, new OrleansBinaryDictionaryOperationCodec<string, int>(new OrleansJournalValueCodec<string>(keyCodec, SessionPool), new OrleansJournalValueCodec<int>(valueCodec, SessionPool)));
    ...
    public async Task DurableDictionary_Persistence_Test()
    {
        ...
        var keyCodec = CodecProvider.GetCodec<string>();
        var valueCodec = CodecProvider.GetCodec<int>();
        var dictionary1 = new DurableDictionary<string, int>("testDict", sut.Manager, new OrleansBinaryDictionaryOperationCodec<string, int>(new OrleansJournalValueCodec<string>(keyCodec, SessionPool), new OrleansJournalValueCodec<int>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
        ...
        var dictionary2 = new DurableDictionary<string, int>("testDict", sut2.Manager, new OrleansBinaryDictionaryOperationCodec<string, int>(new OrleansJournalValueCodec<string>(keyCodec, SessionPool), new OrleansJournalValueCodec<int>(valueCodec, SessionPool)));
    ...
    public async Task DurableDictionary_ComplexKeys_Test()
    {
        ...
        var dictionary = new DurableDictionary<TestKey, string>("complexDict", manager, new OrleansBinaryDictionaryOperationCodec<TestKey, string>(new OrleansJournalValueCodec<TestKey>(keyCodec, SessionPool), new OrleansJournalValueCodec<string>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
    ...
    public async Task DurableDictionary_ComplexValues_Test()
    {
        ...
        var dictionary = new DurableDictionary<string, TestPerson>("peopleDict", manager, new OrleansBinaryDictionaryOperationCodec<string, TestPerson>(new OrleansJournalValueCodec<string>(keyCodec, SessionPool), new OrleansJournalValueCodec<TestPerson>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
    ...
    public async Task DurableDictionary_Clear_Test()
    {
        ...
        var keyCodec = CodecProvider.GetCodec<string>();
        var valueCodec = CodecProvider.GetCodec<int>();
        var dictionary = new DurableDictionary<string, int>("clearDict", manager, new OrleansBinaryDictionaryOperationCodec<string, int>(new OrleansJournalValueCodec<string>(keyCodec, SessionPool), new OrleansJournalValueCodec<int>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
    ...
    public async Task DurableDictionary_Enumeration_Test()
    {
        ...
        var keyCodec = CodecProvider.GetCodec<string>();
        var valueCodec = CodecProvider.GetCodec<int>();
        var dictionary = new DurableDictionary<string, int>("enumDict", manager, new OrleansBinaryDictionaryOperationCodec<string, int>(new OrleansJournalValueCodec<string>(keyCodec, SessionPool), new OrleansJournalValueCodec<int>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
