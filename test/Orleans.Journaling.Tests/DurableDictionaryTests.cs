...
public class DurableDictionaryTests : StateMachineTestBase
{
    ...
    public async Task DurableDictionary_BasicOperations_Test()
    {
        ...
        var dictionary = new DurableDictionary<string, int>("testDict", sut.Manager, new OrleansBinaryDictionaryEntryCodec<string, int>(new OrleansLogDataCodec<string>(keyCodec, SessionPool), new OrleansLogDataCodec<int>(valueCodec, SessionPool)));
    ...
    public async Task DurableDictionary_Persistence_Test()
    {
        ...
        var keyCodec = CodecProvider.GetCodec<string>();
        var valueCodec = CodecProvider.GetCodec<int>();
        var dictionary1 = new DurableDictionary<string, int>("testDict", sut.Manager, new OrleansBinaryDictionaryEntryCodec<string, int>(new OrleansLogDataCodec<string>(keyCodec, SessionPool), new OrleansLogDataCodec<int>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
        ...
        var dictionary2 = new DurableDictionary<string, int>("testDict", sut2.Manager, new OrleansBinaryDictionaryEntryCodec<string, int>(new OrleansLogDataCodec<string>(keyCodec, SessionPool), new OrleansLogDataCodec<int>(valueCodec, SessionPool)));
    ...
    public async Task DurableDictionary_ComplexKeys_Test()
    {
        ...
        var dictionary = new DurableDictionary<TestKey, string>("complexDict", manager, new OrleansBinaryDictionaryEntryCodec<TestKey, string>(new OrleansLogDataCodec<TestKey>(keyCodec, SessionPool), new OrleansLogDataCodec<string>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
    ...
    public async Task DurableDictionary_ComplexValues_Test()
    {
        ...
        var dictionary = new DurableDictionary<string, TestPerson>("peopleDict", manager, new OrleansBinaryDictionaryEntryCodec<string, TestPerson>(new OrleansLogDataCodec<string>(keyCodec, SessionPool), new OrleansLogDataCodec<TestPerson>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
    ...
    public async Task DurableDictionary_Clear_Test()
    {
        ...
        var keyCodec = CodecProvider.GetCodec<string>();
        var valueCodec = CodecProvider.GetCodec<int>();
        var dictionary = new DurableDictionary<string, int>("clearDict", manager, new OrleansBinaryDictionaryEntryCodec<string, int>(new OrleansLogDataCodec<string>(keyCodec, SessionPool), new OrleansLogDataCodec<int>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
    ...
    public async Task DurableDictionary_Enumeration_Test()
    {
        ...
        var keyCodec = CodecProvider.GetCodec<string>();
        var valueCodec = CodecProvider.GetCodec<int>();
        var dictionary = new DurableDictionary<string, int>("enumDict", manager, new OrleansBinaryDictionaryEntryCodec<string, int>(new OrleansLogDataCodec<string>(keyCodec, SessionPool), new OrleansLogDataCodec<int>(valueCodec, SessionPool)));
        await sut.Lifecycle.OnStart();
