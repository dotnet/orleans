...
namespace UnitTests.General
{
    ...
    public class IdentifierTests
    {
        ...
        public void ID_Interning_GrainID()
        {
            ...
            var gid3 = this.environment.Serializer.Deserialize<GrainId>(environment.Serializer.SerializeToArray(gid1));
        ...
        public void ID_Interning_string_equals()
        {
            ...
            // Round-trip through Serializer
            var r3 = this.environment.Serializer.Deserialize<string>(environment.Serializer.SerializeToArray(r1));
        ...
        public void Interning_SiloAddress()
        {
            ...
            // Round-trip through Serializer
            var a3 = this.environment.Serializer.Deserialize<SiloAddress>(environment.Serializer.SerializeToArray(a1));
        ...
        public void GrainReference_Test1()
        {
            ...
            var grainRef = (GrainReference)this.environment.InternalGrainFactory.GetGrain(regularGrainId);
        ...
        private GrainReference RoundTripGrainReferenceToKey(GrainReference input)
        {
            ...
            var output = this.environment.Services.GetRequiredService<GrainReferenceActivator>().CreateReference(GrainId.Parse(str), default);
            return output;
        }
    }
}
