...
public class InMemoryJobQueueTests
{
    ...
    public async Task GetAsyncEnumerator_ReturnsJobsInDueTimeOrder()
    {
        ...
        var results = new List<IDurableJobRun>();
    ...
    private static IDurableJobRun CreateJobContext(DurableJob job, string runId, int dequeueCount)
    {
        var context = Substitute.For<IDurableJobRun>();
