...
namespace NonSilo.Tests.HierarchicalKeys;
...
public class HierarchicalKeyTests
{
    ...
    public void CreateChildKey_WithInvalidSegments_Throws(string value)
    {
        ...
        Assert.Throws<ArgumentException>(() => global::Orleans.HierarchicalKey.Create(parent, value));
    }
    ...
    {
        var key = global::Orleans.HierarchicalKey.CreateEscaped(@"foo\/bar/baz");
    ...
    public void CreateEscaped_CopiesCallerOwnedMemory()
    {
        ...
        var key = global::Orleans.HierarchicalKey.CreateEscaped(parent: null, characters);
    ...
    {
        Assert.Throws<ArgumentException>(() => global::Orleans.HierarchicalKey.CreateEscaped(value));
    }
