...
namespace UnitTests.StorageTests
{
    ...
    public class PersistenceGrainTests_Local : OrleansTestingBase, IClassFixture<PersistenceGrainTests_Local.Fixture>, IDisposable, IAsyncLifetime
    {
        ...
        private async Task SetErrorInjection(string providerName, ErrorInjectionBehavior errorInjectionBehavior) => await ErrorInjectionStorageProvider.SetErrorInjection(providerName, errorInjectionBehavior, this.HostedCluster.GrainFactory);
