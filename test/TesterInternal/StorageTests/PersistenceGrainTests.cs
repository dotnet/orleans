...
namespace UnitTests.StorageTests
{
    ...
    public class PersistenceGrainTests_Local : OrleansTestingBase, IClassFixture<PersistenceGrainTests_Local.Fixture>, IDisposable, IAsyncLifetime
    {
        ...
        {
            var id = Guid.NewGuid();
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceTestGrain>(id);
        ...
        public async Task Persistence_Grain_Init()
        {
            ...
            var mgmtGrain = this.HostedCluster.GrainFactory.GetGrain<IManagementGrain>(0);
        ...
        public async Task Persistence_Grain_Activate_StoredValue()
        {
            ...
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceTestGrain>(guid);
        ...
        public async Task Persistence_Grain_Activate_Error()
        {
            ...
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceProviderErrorGrain>(guid);
        ...
        public async Task MemoryStore_Read_Write()
        {
            var guid = Guid.NewGuid();
            _ = guid.ToString("N");
            var grain = this.HostedCluster.GrainFactory.GetGrain<IMemoryStorageTestGrain>(guid);
        ...
        public async Task MemoryStore_Stress_Read()
        {
            ...
            {
                var grain = this.HostedCluster.GrainFactory.GetGrain<IMemoryStorageTestGrain>(Guid.NewGuid());
                var idx = i; // Capture
        ...
        public async Task Persistence_Grain_Read_Error()
        {
            const string providerName = MockStorageProviderName1;
            var id = Guid.NewGuid();
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceErrorGrain>(id);
        ...
        public async Task Persistence_Grain_ReRead_Error()
        {
            ...
            var guid = Guid.NewGuid();
            _ = guid.ToString("N");
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceErrorGrain>(guid);
            _ = await grain.GetValue();
        ...
        public async Task Persistence_Provider_Error_BeforeWrite()
        {
            var id = Guid.NewGuid();
            var providerName = ErrorInjectorProviderName;
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceProviderErrorGrain>(id);
        ...
        public async Task Persistence_Error_Handled_Read()
        {
            ...
            var guid = Guid.NewGuid();
            _ = guid.ToString("N");
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceUserHandledErrorGrain>(guid);
        ...
        public async Task Persistence_Provider_Loop_Read()
        {
            ...
            {
                var expectedVal = i;
                var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceTestGrain>(Guid.NewGuid());
        ...
        {
            var grain = this.HostedCluster.GrainFactory.GetGrain<IBadProviderTestGrain>(Guid.NewGuid());
        ...
        public async Task MemoryStore_UserGrain_Read_Write()
        {
            ...
            var friend1 = this.HostedCluster.GrainFactory.GetGrain<IUser>(id1);
            var friend2 = this.HostedCluster.GrainFactory.GetGrain<IUser>(id2);
        ...
        public async Task Persistence_Grain_NoState()
        {
            const string providerName = MockStorageProviderName1;
            var id = Guid.NewGuid();
            var grain = this.HostedCluster.GrainFactory.GetGrain<IPersistenceNoStateTestGrain>(id);
        ...
        public async Task Serialize_GrainState_DeepCopy_Stress()
        {
            ...
            for (var i = 0; i < num; i++)
            {
                var grain = this.HostedCluster.GrainFactory.GetGrain<IUser>(Guid.NewGuid());
        ...
        public async Task ReentrentGrainWithState()
        {
            var id1 = Guid.NewGuid();
            var id2 = Guid.NewGuid();
            var grain1 = this.HostedCluster.GrainFactory.GetGrain<IReentrentGrainWithState>(id1);
            var grain2 = this.HostedCluster.GrainFactory.GetGrain<IReentrentGrainWithState>(id2);
        ...
        {
            var id1 = Guid.NewGuid();
            var grain1 = this.HostedCluster.GrainFactory.GetGrain<INonReentrentStressGrainWithoutState>(id1);
            await grain1.Test1();
        }
        ...
        {
            var id1 = Guid.NewGuid();
            var grain = this.HostedCluster.GrainFactory.GetGrain<IStateInheritanceTestGrain>(id1);
