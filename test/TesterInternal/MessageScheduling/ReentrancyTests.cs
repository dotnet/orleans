...
namespace UnitTests
{
    ...
    public class ReentrancyTests : OrleansTestingBase, IClassFixture<ReentrancyTests.Fixture>
    {
        ...
        {
            var grain = fixture.GrainFactory.GetGrain<IFirstGrain>(Guid.NewGuid());
        ...
        {
            var reentrant = fixture.GrainFactory.GetGrain<IReentrantGrain>(GetRandomGrainId());
            ...
            fixture.Logger.LogInformation("Reentrancy ReentrantGrain Test finished OK.");
        }

        [Fact, TestCategory("Functional"), TestCategory("Tasks"), TestCategory("Reentrancy")]
        public void NonReentrantGrain_WithMayInterleaveStaticPredicate_WhenPredicateReturnsTrue()
        {
            var grain = fixture.GrainFactory.GetGrain<IMayInterleaveStaticPredicateGrain>(GetRandomGrainId());
            ...
            fixture.Logger.LogInformation("Reentrancy NonReentrantGrain_WithMayInterleaveStaticPredicate_WhenPredicateReturnsTrue Test finished OK.");
        }
        ...
        public async Task NonReentrantGrain_WithMayInterleaveStaticPredicate_WhenPredicateThrows()
        {
            ...
            fixture.Logger.LogInformation("Reentrancy NonReentrantGrain_WithMayInterleaveStaticPredicate_WhenPredicateThrows Test finished OK.");
        }

        [Fact, TestCategory("Functional"), TestCategory("Tasks"), TestCategory("Reentrancy")]
        public void NonReentrantGrain_WithMayInterleaveInstancedPredicate_WhenPredicateReturnsTrue()
        {
            var grain = fixture.GrainFactory.GetGrain<IMayInterleaveInstancedPredicateGrain>(GetRandomGrainId());
            grain.SetSelf(grain).Wait();
            try
            {
                Assert.True(grain.TwoReentrant().Wait(2000), "Grain should reenter when MayInterleave predicate returns true");
            ...
            fixture.Logger.LogInformation("Reentrancy NonReentrantGrain_WithMayInterleaveInstancedPredicate_WhenPredicateReturnsTrue Test finished OK.");
        }
        ...
        public async Task NonReentrantGrain_WithMayInterleaveInstancedPredicate_WhenPredicateThrows()
        {
            ...
            fixture.Logger.LogInformation("Reentrancy NonReentrantGrain_WithMayInterleaveInstancedPredicate_WhenPredicateThrows Test finished OK.");
        }
        ...
        public void Reentrancy_Deadlock_1()
        {
            ...
            var grain2 = fixture.GrainFactory.GetGrain<IReentrantSelfManagedGrain>(2);
            grain2.SetDestination(1).Wait();
            done.Add(grain2.Ping(15));

            Task.WhenAll(done).Wait();
            fixture.Logger.LogInformation("ReentrancyTest_Deadlock_1 OK - no deadlock.");
        }
        ...
        public void Reentrancy_Deadlock_2()
        {
            ...
            var grain2 = fixture.GrainFactory.GetGrain<INonReentrantSelfManagedGrain>(2);
            grain2.SetDestination(1).Wait();

            fixture.Logger.LogInformation("ReentrancyTest_Deadlock_2 is about to call grain1.Ping()");
            done.Add(grain1.Ping(15));
            fixture.Logger.LogInformation("ReentrancyTest_Deadlock_2 is about to call grain2.Ping()");
            done.Add(grain2.Ping(15));

            Task.WhenAll(done).Wait();
            fixture.Logger.LogInformation("ReentrancyTest_Deadlock_2 OK - no deadlock.");
        }
