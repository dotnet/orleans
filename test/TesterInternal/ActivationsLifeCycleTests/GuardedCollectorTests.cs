...
{
    public class GuardedCollectorTests : OrleansTestingBase, IAsyncLifetime
    {
                ...
                hostBuilder.UseOrleans((ctx, siloBuilder) =>
                {
                    siloBuilder
                        .ConfigureServices(services =>
                        {
                            ...
                            services.AddSingleton<IGrainCollectionGuard, ProcessMemoryGrainCollectionGuard>();
                            services.AddSingleton<IGrainCollectionGuard, SystemMemoryGrainCollectionGuard>();
                        });
        ...
        [Fact, TestCategory("ActivationCollector"), TestCategory("Functional")]
        public async Task ActivationCollectorShouldNotCollectBusyOrIdleActivations()
        {
            await Initialize(DEFAULT_IDLE_TIMEOUT);
            ...
            Assert.Equal(idleGrainCount, idleActivationsNotCollected);
        ...
        [Fact, TestCategory("ActivationCollector"), TestCategory("Functional")]
        public async Task ActivationCollectorShouldNotCollectIdleActivationsSpecifiedInPerTypeConfiguration()
        {
            ...
            int activationsNotCollected = await TestUtils.GetActivationCount(this.testCluster.GrainFactory, fullGrainTypeName);
            Assert.Equal(grainCount, activationsNotCollected);
        }
