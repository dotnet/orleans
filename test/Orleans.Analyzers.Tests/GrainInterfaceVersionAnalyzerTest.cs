...
";
        ...
        Assert.Contains("dotnet format PATH_TO_PROJECT.csproj", diagnostic.GetMessage());
        Assert.Contains("dotnet tool run orleans-contracts PATH_TO_SOLUTION", diagnostic.GetMessage());
...
";
        ...
        bool useRepositoryBuildTargets = false)
    {
        ...
        try
        {
            ...
            var analyzerItem = $"    <Analyzer Include=\"{EscapeXml(analyzerPath)}\" />{Environment.NewLine}";
            await File.WriteAllTextAsync(
                ...
                <Project Sdk="Microsoft.NET.Sdk">
                  ...
                  <PropertyGroup>
                    ...
                    <OrleansContractsAnalyzerPath>{EscapeXml(contractsAnalyzerPath)}</OrleansContractsAnalyzerPath>
