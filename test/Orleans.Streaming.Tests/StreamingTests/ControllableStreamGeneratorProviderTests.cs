    ...
    public class ControllableStreamGeneratorProviderTests : OrleansTestingBase, IClassFixture<ControllableStreamGeneratorProviderTests.Fixture>
    {
        ...
        private async Task ValidateControllableGeneratedStreams(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                object?[] results = await mgmt.SendControlCommandToProvider<PersistentStreamProvider>(Fixture.StreamProviderName, (int)StreamGeneratorCommand.Configure, generatorConfig, cancellationToken);
