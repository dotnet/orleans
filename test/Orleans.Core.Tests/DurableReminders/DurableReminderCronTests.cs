...
internal static class DurableReminderTimeZoneTestHelper
{
...
public class ReminderCronBuilderTimeZoneTests
{
    ...
    {
        var builder = ReminderCronBuilder.DailyAt(9, 0).InTimeZone(DurableReminderTimeZoneTestHelper.GetCentralEuropeanTimeZone());
    ...
    {
        var builder = ReminderCronBuilder.DailyAt(9, 0).InTimeZone(DurableReminderTimeZoneTestHelper.GetUsEasternTimeZone());
    ...
    {
        var alternateZoneId = DurableReminderTimeZoneTestHelper.GetCentralEuropeanAlternateTimeZoneId();
    ...
    public async Task RegistryRegistrationExtensions_WithNonUtcBuilder_DelegatesEncodedSchedule()
    {
        ...
        var zone = DurableReminderTimeZoneTestHelper.GetCentralEuropeanTimeZone();
...
public class ReminderCronExpressionTimeZoneTests
{
    ...
    {
        var expression = ReminderCronExpression.Parse("0 9 * * *");
        var zone = DurableReminderTimeZoneTestHelper.GetUsEasternTimeZone();
