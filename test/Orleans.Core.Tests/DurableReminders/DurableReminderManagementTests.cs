...
public class ReminderManagementGrainTests
{
    ...
    public async Task RepairAsync_ForCronReminder_RecomputesNextOccurrenceUsingStoredTimeZone()
    {
        ...
        var timeZone = DurableReminderTimeZoneTestHelper.GetCentralEuropeanTimeZone();
    ...
    private sealed class InMemoryManagementReminderTable(params ReminderEntry[] reminders) : Orleans.DurableReminders.IReminderTable
    {
...
public class ReminderStressTests
{
    ...
    private sealed class SingleSegmentReminderTable(List<ReminderEntry> reminders) : Orleans.DurableReminders.IReminderTable
    {
