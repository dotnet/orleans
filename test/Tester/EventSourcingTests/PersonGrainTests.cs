...
namespace Tester.EventSourcingTests
{
    public class PersonGrainTests : IClassFixture<EventSourcingClusterFixture>
    {
        ...
        {
            var grainWithState = fixture.GrainFactory.GetGrain<IPersonGrain>(Guid.Empty);
        ...
        {
            var leia = fixture.GrainFactory.GetGrain<IPersonGrain>(Guid.NewGuid());
            await leia.RegisterBirth(new PersonAttributes { FirstName = "Leia", LastName = "Organa", Gender = GenderType.Female });

            var han = fixture.GrainFactory.GetGrain<IPersonGrain>(Guid.NewGuid());
